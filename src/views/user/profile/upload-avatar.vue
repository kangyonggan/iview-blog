<template>
    <div>
        <div style="text-align: center;">
            <img ref="avatar" :src="avatar" class="avatar" @click="showBigAvatar = !showBigAvatar"/>

            <Modal v-model="showBigAvatar" footerHide>
                <img :src="avatar" @click="showBigAvatar = !showBigAvatar" v-if="showBigAvatar" class="bigAvatar">
            </Modal>
        </div>
